...
class UserUseView extends StatefulWidget {
  final UserData data;

  UserUseView(this.data);

  @override
  _UserUseViewState createState() => _UserUseViewState();
}

class _UserUseViewState extends State<UserUseView> {
  List<Widget> list = new List();

  @override
  void initState() {
    for (int i = 0; i < widget.data.useData.length; i++) {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < widget.data.useData.length; i++) {
      data.add(Usage(i, widget.data.useData[i].use));
    }
